import{e as oi,E as Kr,i as qr,_ as Wr}from"./info.vue_vue_type_script_setup_true_lang-0e30a0f7.js";import{d as Xr,A as Yr,b as ai,w as hi,_ as Jr,o as Me,g as xe,e as Yt,c as Qr,h as Zr,F as to,i as eo,j as no}from"./index-7449d560.js";import{_ as io}from"./Col.vue_vue_type_script_setup_true_lang-5a954fc1.js";import{N as so}from"./Navigation-5cfd8ded.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hr="storage";function au(t,e){return t=me(t),ru(t,e)}function hu(t=Tn(),e){t=me(t);const i=vt(t,Hr).getImmediate({identifier:e}),s=ts("storage");return s&&cu(i,...s),i}function cu(t,e,n,i={}){ou(t,e,n,i)}function lu(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),i=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new si(n,i,s,e,as)}function uu(){X(new K(Hr,lu,"PUBLIC").setMultipleInstances(!0)),B(Xi,Yi,""),B(Xi,Yi,"esm2017")}uu();const fu={apiKey:"AIzaSyDAU45Y4DS5yuxAOcBcOZ-lSoyrrtWBkXc",authDomain:"tdtu-ae215.firebaseapp.com",projectId:"tdtu-ae215",storageBucket:"tdtu-ae215.appspot.com",messagingSenderId:"113659924698",appId:"1:113659924698:web:15edfff68dc5a3f38795e3",measurementId:"G-P9KSETPGRX"},ri=hs(fu);sc(ri);kl(ri);const du=hu(ri),_u=Xr({__name:"page",setup(t){const e=au(du,"banners");return console.log(e),Yr.init(),(n,i)=>(Me(),ai(Jr,{label:"ILMIY–TADQIQOTLAR INNOVATSIYALAR VA PEDAGOGIK KADRLARNI TAYYORLASH BO’LIMI"},{default:hi(()=>[xe(io,null,{default:hi(()=>[Yt(oi).length!==0?(Me(!0),Qr(to,{key:0},Zr(Yt(oi),(s,r)=>(Me(),ai(Kr,{image:s==null?void 0:s.image,fullname:s==null?void 0:s.fullname,postsia:s==null?void 0:s.postsia,exprence:s==null?void 0:s.exprence,phone:s==null?void 0:s.phone,email:s==null?void 0:s.email,key:r},null,8,["image","fullname","postsia","exprence","phone","email"]))),128)):eo("",!0)]),_:1}),xe(Wr,{"data-aos":"fade-left","data-aos-anchor":"#example-anchor","data-aos-offset":"500","data-aos-duration":"500",title:"Ilmiy–tadqiqotlar innovatsiyalar va pedagogik kadrlarni tayyorlash bo’limi quydagi vazifalarni bajaradi:",info:Yt(qr)},null,8,["info"]),xe(so,{data:Yt(no)[1].items},null,8,["data"])]),_:1}))}});export{_u as default};
